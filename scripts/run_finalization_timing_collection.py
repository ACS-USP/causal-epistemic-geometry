#!/usr/bin/env python3
"""Pure validation boundary for the frozen finalization-timing lock."""
...
from epistemic_geometry.benchmarks.reasoning.finalization_timing_journal import (  # noqa: E402, I001
...
def execute_collection(
    ...
    *,
    ...
    make_journal = journal_factory or FinalizationTimingJournal
    ...
    invoke = runner or run_serial_finalization_timing
    records = invoke(
        backend,
        loaded["manifest"],
        schedule,
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate a frozen finalization-timing lock.")
    parser.add_argument(
        "lock_path",
        nargs="?",
        type=Path,
        default=ROOT / "review/q1_finalization_timing/PRELOCK_ARTIFACTS/LOCK.json",
    )
