#!/usr/bin/env python3
"""Generate the hash-validated Q1 paper figures and deterministic figure tables."""
...
from epistemic_geometry.publication.q1.loaders import validate_frozen_sources  # noqa: E402
from epistemic_geometry.publication.q1.pipeline import generate_visual_evidence  # noqa: E402
...
def main() -> None:
    ...
    if args.as_json:
        ...
        print("Q1 publication source validation: PASS")
