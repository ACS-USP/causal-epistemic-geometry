#!/usr/bin/env python3
"""Hash Gate-13.1 closeout artifacts and create a verified review bundle."""
...
BUNDLE = ROOT / "review/gate13_1_all_layer_causal_atlas_bundle.tar.gz"
...
def main() -> int:
    excluded = {"manifest_hashes.json", "BUNDLE_METADATA.json"}
    records = {
