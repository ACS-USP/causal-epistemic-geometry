...
| Q2 matched random rank-8 design | Is learned-subspace alignment specific relative to random subspace orientations? | DESIGN_ONLY — NOT RUN | `Q2_MATCHED_RANDOM_RANK8_CONTROL_REQUIRES_FURTHER_THEORY`; subspace-level safety-conditioning and compute/power unresolved | [design review](../review/q2_matched_random_rank8_control_design/DESIGN_REVIEW.md) |
