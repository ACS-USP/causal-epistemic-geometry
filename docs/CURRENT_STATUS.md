...
**Scientific stage:** `Q2_V3_FREEZE_READY_M3_EXCLUDED_PROVENANCE_RESOLVED`
...
- Workstream: `Q2_M3_QUALIFICATION_CRUXEVAL_PROVENANCE`
...
- `current_task`: `Q2_V3_FREEZE_READY_AWAITING_PRINCIPAL_RESEARCHER_REVIEW`
