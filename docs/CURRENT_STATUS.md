...
**Scientific stage:** `Q2_DEVELOPMENT_V2_COST_BLOCKED`
...
- RunPod: `STOPPED_ZERO_ACTIVE_GPU_RETAINED_POD_DISK`
- GPU work authorized: `false`
- New scientific experiment authorized: `none_pending_principal_review`
...
- `geometry_q2`: `Q2_V2_BANK_QUALIFIED_COMMON_PANEL_NOT_RUN_COST_BLOCKED`
- `committee_q3`: `NOT_RUN`
- `confirmatory_holdout`: `CONSUMED_CONFIRMATORY_CLOSED`
- `model_downloads_local`: `FORBIDDEN`
- `current_task`: `Q2_V2_COST_GATE_BLOCKED_COMMON_PANEL_NOT_RUN`
