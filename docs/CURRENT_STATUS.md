...
**Scientific stage:** `Q3_1_PROMPT_REPRESENTATION_DEVELOPMENT_CLOSED`
...
- Workstream: `Q3_ROUTE_A_PROMPT_REPRESENTATION`
- Evidence level: `DEVELOPMENT_ONLY`
- Lifecycle: `DEVELOPMENT_REVIEW_CLOSED`
- Branch: `research/q3-route-a-prompt-representation`
- Status: `Q3_ROUTE_A_REPRESENTATION_SELECTABLE_BUT_GEOMETRY_NOT_INCREMENTAL`
