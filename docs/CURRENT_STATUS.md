...
**Scientific stage:** `Q2_DEVELOPMENT_BANK_QUALIFICATION_CLOSED`
...
- Workstream: `Q2_CONTROLLER_HELDOUT_GEOMETRY_PILOT_COMPLETE`
- RunPod: `TERMINATED`
...
- `geometry_q2`: `DEVELOPMENT_BANK_NOT_QUALIFIED_NO_PREDICTIVE_OUTCOMES`
- `committee_q3`: `NOT_RUN`
- `confirmatory_holdout`: `CONSUMED_CONFIRMATORY_CLOSED`
- `model_downloads_local`: `FORBIDDEN`
- `current_task`: `Q2_BANK_POSTMORTEM_CLOSED`
