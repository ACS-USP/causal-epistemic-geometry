...
**Scientific stage:** `Q2_DEVELOPMENT_V2_ENGINE_QUALIFIED_WALLET_BLOCKED`
...
- `geometry_q2`: `Q2_V2_ENGINE_QUALIFIED_COMMON_PANEL_BLOCKED_INSUFFICIENT_WALLET`
- `committee_q3`: `NOT_RUN`
- `confirmatory_holdout`: `CONSUMED_CONFIRMATORY_CLOSED`
- `model_downloads_local`: `FORBIDDEN`
- `current_task`: `Q2_V2_WALLET_BLOCKED_COMMON_PANEL_UNTOUCHED`
