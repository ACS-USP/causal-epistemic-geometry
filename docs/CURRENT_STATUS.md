...
**Scientific stage:** `Q2_DEVELOPMENT_V2_EXECUTION_COST_QUALIFICATION`
...
- RunPod: `ENGINE_QUALIFICATION_AUTHORIZED_RETAINED_A40_STOPPED`
- GPU work authorized: `true`
- New scientific experiment authorized: `q2_v2_common_panel_after_engine_and_cost_pass`
...
|---|---|---|
| `Q2_CONTROLLER_HELDOUT_GEOMETRY_V2` | `BLOCKED_PROJECTED_COST` | Six of six conceptual source axes qualified, and label-free per-direction calibration produced a qualified bank of 24 meaningful controllers across six families, including 12 causal directions and four dose bins. Four fresh nulls are SVD-span-orthogonal. The synthetic throughput preflight projected a US$37.3499 cumulative cost, above the frozen US$25 ceiling, so the 120-item common panel and predictive M0/M1/M2 analyses were not run. This is an operational cost block, not a predictive Q2 null. |
...
- `geometry_q2`: `Q2_V2_BANK_QUALIFIED_EXECUTION_COST_QUALIFICATION`
- `committee_q3`: `NOT_RUN`
- `confirmatory_holdout`: `CONSUMED_CONFIRMATORY_CLOSED`
- `model_downloads_local`: `FORBIDDEN`
- `current_task`: `Q2_V2_EXECUTION_ENGINE_COST_QUALIFICATION_COMMON_PANEL_UNTOUCHED`
- `free_generation`: `NOT_AUTHORIZED; ONLY_FROZEN_Q2_V2_PHASES`
