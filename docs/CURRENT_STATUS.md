...
**Scientific stage:** `Q2_DEVELOPMENT`
...
- Workstream: `Q2_CONTROLLER_HELDOUT_GEOMETRY_PILOT`
- RunPod: `TERMINATED`
...
- `geometry_q2`: `AUTHORIZED_DEVELOPMENT_PROSPECTIVE_LOCK`
- `committee_q3`: `NOT_RUN`
- `confirmatory_holdout`: `CONSUMED_CONFIRMATORY_CLOSED`
- `model_downloads_local`: `FORBIDDEN`
- `current_task`: `Q2_CONTROLLER_BANK_QUALIFICATION`
- `free_generation`: `Q2_ONLY`
