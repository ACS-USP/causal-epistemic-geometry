...
**Scientific stage:** `Q2_DEVELOPMENT_V2_PRE_SOURCE_LOCK`
...
- `geometry_q2`: `Q2_V2_PRE_SOURCE_LOCK_NO_COMMON_OUTCOMES`
- `committee_q3`: `NOT_RUN`
- `confirmatory_holdout`: `CONSUMED_CONFIRMATORY_CLOSED`
- `model_downloads_local`: `FORBIDDEN`
- `current_task`: `Q2_V2_CALIBRATED_BANK_REBUILD_PRE_SOURCE`
