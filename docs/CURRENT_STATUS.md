...
**Scientific stage:** `Q2_V3_EXECUTION_AUTHORIZED`
...
- Workstream: `Q2_V3_RADIAL_ANGULAR_EXECUTION`
- RunPod: `TERMINATED_ZERO_ACTIVE_RESOURCES`
- GPU work authorized: `true`
- New scientific experiment authorized: `q2_v3_only`
...
- `current_task`: `Q2_V3_EXECUTION_AUTHORIZED`
- `free_generation`: `AUTHORIZED_Q2_V3_ONLY_AFTER_ALL_FROZEN_PREPANEL_GATES`
